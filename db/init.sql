...
-- db/migrations/006_add_help_remaining_pages.sql
--
-- Seed sadržaja pomoći za svih preostalih 26 stranica (kontekst i
-- zainteresovane-strane su već popunjene kroz migracije 004 i 005).
-- Tabela help_content već postoji - ovo samo dodaje redove.
--
-
-- INSERT IGNORE čini fajl bezbednim za slučajno ponovno pokretanje -
-- neće prepisati sadržaj koji je već ručno izmenjen kroz
-- "Uređivanje pomoći".
